...
const educationData = [
    {
        ...
        date: '2024 - 2027',
        description: 'Learning core software engineering concepts, hardware basics, and programming.'
    }
];
...
const experienceData = [
    {
        ...
        date: '2025 - Present',
        description: 'Currently working on full-stack MERN applications with scalable architectures.'
    },
    {
        title: 'Learning Backend Development',
        institute: 'Node.js & Express',
        date: '2025',
        description: 'Mastered server-side programming, RESTful APIs, and database management with MongoDB.'
    },
    {
