                ...
                <div className="order-2 md:order-1 flex-1 text-left flex flex-col items-start gap-4">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap gap-4 mb-10">
                            <Link to="projects" smooth={true} duration={500} offset={-50} className="cursor-pointer">
                                <motion.div
                            ...
                            <Link to="contact" smooth={true} duration={500} offset={-50} className="cursor-pointer">
                                <motion.div
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
