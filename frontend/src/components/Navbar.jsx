                    ...
                    >
                        {navLinks.map((link) => (
                            <Link
                                ...
                                className="relative text-2xl font-semibold text-gray-200 hover:text-primaryAccent transition-colors group"
                            >
                                {link.name}
                                <span className="absolute left-0 -bottom-1 w-0 h-[3px] bg-primaryAccent transition-all duration-300 group-hover:w-full"></span>
                            </Link>
                        ))}
                    </motion.div>
                )}
